    ...
    <nav className="fixed top-0 left-0 w-full h-36 bg-white shadow-[0px_1px_0px_rgba(71,167,235,0.1)] z-50">
      <div className="relative w-full h-full">
        ...
        <div className="absolute left-[803px] top-[93px] h-[18px] w-[61px]">
          <a href="#seo-services" className="text-[#0c3745] font-inter text-[14.9px] font-medium hover:text-[#47a7eb] transition-colors">
            SEO Services
          </a>
        </div>
        
        <div className="absolute left-[904px] top-[93px] h-[18px] w-[59px]">
          <a href="#case-studies" className="text-[#0c3745] font-inter text-[14.4px] font-medium hover:text-[#47a7eb] transition-colors">
            Case Studies
          </a>
        </div>
        
        <div className="absolute left-[1003px] top-[93px] h-[18px] w-[42px]">
          <a href="#pricing" className="text-[#0c3745] font-inter text-[14.5px] font-medium hover:text-[#47a7eb] transition-colors">
            Pricing
          </a>
        </div>
        
        <div className="absolute left-[1085px] top-[93px] h-[18px] w-[32px]">
          <a href="#tools" className="text-[#0c3745] font-inter text-[15.1px] font-medium hover:text-[#47a7eb] transition-colors">
            Tools
          </a>
        </div>
